...
//    __unsafe_unretained NSString *preset_str;
...
//    __unsafe_unretained AVCaptureDevice             *dev;
//};
//
///* darwin factory */
...
//};
//
//@interface MVOutDelegate: NSObject
//			 <AVCaptureVideoDataOutputSampleBufferDelegate>
//{
//@public
//    struct darwin_stream *vstream;
//}
//@end
//
///* Video stream. */
...
//    pj_bool_t               is_planar;
//    __unsafe_unretained NSLock 		   *frame_lock;
//    void                   *capture_buf;
//    void		   *frame_buf;
//    
...
//    
//    __unsafe_unretained AVCaptureSession		*cap_session;
//    __unsafe_unretained AVCaptureDeviceInput	*dev_input;
//    __unsafe_unretained AVCaptureVideoDataOutput	*video_output;
//    __unsafe_unretained MVOutDelegate		*vout_delegate;
//    __unsafe_unretained dispatch_queue_t 		 queue;
//    __unsafe_unretained AVCaptureVideoPreviewLayer  *prev_layer;
//    
//#if TARGET_OS_IPHONE
//    void		*render_buf;
//    pj_size_t		 render_buf_size;
//    CGDataProviderRef    render_data_provider;
//    __unsafe_unretained UIView              *render_view;
//#endif
//
...
//}
//
//@implementation MVOutDelegate
//#if TARGET_OS_IPHONE
//- (void)update_image
//{
//    CGColorSpaceRef colorSpace = CGColorSpaceCreateDeviceRGB();
//    CGImageRef cgIm = CGImageCreate(vstream->size.w, vstream->size.h,
//                                    8, 32, vstream->bytes_per_row, colorSpace,
//                                    kCGImageAlphaFirst |
//                                    kCGBitmapByteOrder32Little,
//                                    vstream->render_data_provider, 0,
//                                    false, kCGRenderingIntentDefault);
//    CGColorSpaceRelease(colorSpace);
//    
//    vstream->render_view.layer.contents = (__bridge id)(cgIm);
//    CGImageRelease(cgIm);
//}
//#endif
//
...
//
//    [vstream->frame_lock lock];
//    
//    if (vstream->is_planar && vstream->capture_buf) {
//        if (vstream->param.fmt.id == PJMEDIA_FORMAT_I420) {
...
//            if (height != vstream->vid_size.h) {
//                vstream->vid_size.w = vstream->vid_size.h;
//                vstream->vid_size.h = height;
//            }
//            
//            need_clip = (stride != vstream->vid_size.w);
//            
//            p = (pj_uint8_t*)CVPixelBufferGetBaseAddressOfPlane(img, 0);
//            p_len = vstream->vid_size.w * vstream->vid_size.h;
//            Y = (pj_uint8_t*)vstream->capture_buf;
//            U = Y + p_len;
//            V = U + p_len/4;
//
//            if (!need_clip) {
...
//            } else {
//                int i = 0;
//                for (; i < vstream->vid_size.h; ++i) {
//                    pj_memcpy(Y, p, vstream->vid_size.w);
//                    Y += vstream->vid_size.w;
//                    p += stride;
//                }
//            }
//
...
//            } else {
//                int i = 0;
//                for (;i<(vstream->vid_size.h)/2;++i) {
//                    int y=0;
//                    for (;y<(vstream->vid_size.w)/2;++y) {
//                        *U++ = *p++;
//                        *V++ = *p++;
//                    }
//                    p += (stride - vstream->vid_size.w);
//                }
//            }
//        }
//    } else {
//        pj_memcpy(vstream->capture_buf, CVPixelBufferGetBaseAddress(img),
//                  vstream->frame_size);
//    }
//    
...
//        vstream->frame_buf = frame_buf;
//    }
//
//    vstream->frame_ts.u64 += vstream->ts_inc;
//    [vstream->frame_lock unlock];
//    
...
//
//#if TARGET_OS_IPHONE
//PJ_DECL(pj_status_t) darwin_init_view(struct darwin_stream *strm)
//{
...
//    strm->param.window.info.ios.window = (__bridge void *)(strm->render_view);
//
...
//
//	strm->vout_delegate = [MVOutDelegate alloc];
//	strm->vout_delegate->vstream = strm;
//	strm->queue = dispatch_queue_create("mvout_queue",
...
//
///* API: Get stream info. */
//PJ_DECL(pj_status_t) darwin_stream_get_param(pjmedia_vid_dev_stream *s,
...
//
///* API: get capability */
//PJ_DECL(pj_status_t) darwin_stream_get_cap(pjmedia_vid_dev_stream *s,
...
//            hwnd->info.ios.window = (__bridge void*)strm->render_view;
//            return PJ_SUCCESS;
//        }
//#endif /* TARGET_OS_IPHONE */
//        default:
...
//
///* API: set capability */
//PJ_DECL(pj_status_t) darwin_stream_set_cap(pjmedia_vid_dev_stream *s,
//				         pjmedia_vid_dev_cap cap,
//				         const void *pval)
//{
//    struct darwin_stream *strm = (struct darwin_stream*)s;
...
//        case PJMEDIA_VID_DEV_CAP_OUTPUT_WINDOW:
//        {
//            UIView *view = (__bridge UIView *)pval;
...
//	    }
//	    
////            pjmedia_vid_dev_conv_resize_and_rotate(&strm->conv,
////                                                   strm->capture_buf,
////                                                   strm->frame_buf);
//	    

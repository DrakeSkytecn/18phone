...
+ (GSAccountConfiguration *)defaultConfiguration; ///< Creates a GSAccountConfiguration instance with default configuration values.
+ (GSAccountConfiguration *)configurationWithConfiguration:(GSAccountConfiguration *)configuration; ///< Copy constructor.

export PJDIR := /Users/daiquanyi/Documents/pjproject-2.5.5
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-I/Users/daiquanyi/Documents/pjproject-2.5.5/third_party/openh264/include -O2 -Wno-unused-label -DPJ_SDK_NAME="\"iPhoneOS9.3.sdk\"" -arch arm64 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.3.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-L/Users/daiquanyi/Documents/pjproject-2.5.5/third_party/openh264/lib -O2 -arch arm64 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.3.sdk -framework AudioToolbox -framework Foundation
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lopenh264 -lstdc++ -lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework UIKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework OpenGLES
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-I/Users/daiquanyi/Documents/pjproject-2.5.5/third_party/openh264/include -O2 -Wno-unused-label -DPJ_SDK_NAME="\"iPhoneOS9.3.sdk\"" -arch arm64 -isysroot /Applications/XCode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS9.3.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1

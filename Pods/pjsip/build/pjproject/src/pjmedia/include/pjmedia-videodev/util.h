 ...
 */
PJ_DECL(pj_status_t) pjmedia_vid_dev_conv_create_converter(pjmedia_vid_dev_conv *conv,
				      pj_pool_t *pool,
				      pjmedia_format *fmt,
				      pjmedia_rect_size src_size,
				      pjmedia_rect_size dst_size,
...
/* Set rotation */
PJ_DECL(void) pjmedia_vid_dev_conv_set_rotation(pjmedia_vid_dev_conv *conv,
				       pjmedia_orient rotation);

/* Resize the buffer and rotate it, if necessary */
PJ_DECL(pj_status_t) pjmedia_vid_dev_conv_resize_and_rotate(pjmedia_vid_dev_conv *conv,
				      		    void *src_buf,
				      		    void **result);

/* Destroy converter */
PJ_DECL(void) pjmedia_vid_dev_conv_destroy_converter(pjmedia_vid_dev_conv *conv);

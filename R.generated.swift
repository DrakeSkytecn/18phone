...
struct R: Rswift.Validatable {
  ...
  fileprivate static let hostingBundle = Bundle(identifier: "com.kratos.18phone") ?? Bundle.main
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "female") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'female' is used in storyboard 'Main', but couldn't be loaded.") }
